...
<div class="container" id="container">
  ...
  <div class="card bg-light" id="container">
    <article class="card-body mx-auto" max-width="700px" id="container">
      ...
      <div class="zoomin">
      <img class="img-thumbnail" id="zoom" onclick="controlador()" width="400px" height="400px" src="data:image/jpg;charset=utf8;base64,<?= (!empty($profile->avatar) ? base64_encode($profile->avatar) : $defaultImage ); ?>" />
      </div>
